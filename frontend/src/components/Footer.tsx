      ...
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center relative z-10">
        ...
        <div className="mb-4 lg:mb-0 lg:w-1/2 lg:pr-6"> {/* Width between 1/3 and 2/3 */}
          ...
          <p className="text-white text-sm">
            <i>CampusNest</i> aims to revolutionize student accommodation searches, providing real-time availability, transparent reviews, and personalized roommate matching for Christ University students in SG Palya.
          </p><br></br>
